...
public class FacebookLoginTest {
    ...
    public void testFacebook() {
        ...
        try {
            WebElement acceptAllCookiesBtn = new WebDriverWait
                    (driver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable
                    (By.xpath("//button[contains(., 'Permite')]")));
        ...
        WebElement element = driver.findElement(By.linkText("Găseşte-ţi contul şi conectează-te."));
